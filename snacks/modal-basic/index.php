...
<style>
    ...
    /*recommended css for all pages*/
    html {/*border-box is more intuitive and should always start with this as default imo*/
        box-sizing: border-box;
    }
    body {/*browsers often add a margin or padding by default*/
        margin: 0px;
        padding: 0px;
    }
    .group {
...
<div style="width: 100%">
    ...
    foreach ($files as $file) {
        if (pathinfo($file,PATHINFO_EXTENSION)=="css"){
            echo "<a style='margin: 3px' href='?modal-theme=$file'>".pathinfo($file, PATHINFO_BASENAME)."</a>";
        }
    }
    ?>
</div>
...
The important parts of css are:
 ...
 -->
<!--<link rel="stylesheet" href="modals.css">  the default basic style-->
...
<div id="myModal" class="modal-shade">
    ...
    <div class="modal-container" style="background: #595959">
        ...
        <div class="modal-body">
            ...
            <p>There is some text and a button here for testing themes as well.</p>
            <button>OK</button>
        </div>
